 ...
 * This is for the Next.js caller and local Node probe. Cloudflare Workers use
 * their Web Crypto equivalent because Worker bundles cannot import node:crypto.
 */
